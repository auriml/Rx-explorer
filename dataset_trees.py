...
#filename = 'PADCHEST_chest_x_ray_images_labels_160K_01.02.19.csv'
filename = 'covid_iter_1.csv'
filename = 'all_info_studies_labels' + fileSuffix
filetree = '/manual_review/trees_code.txt'
